...
import car1 from '../../../asset/Project pic/car1.png'
import car2 from '../../../asset/Project pic/Car2.png'
import car3 from '../../../asset/Project pic/car3.png'
...
const ResellerCar = () => {
    return (
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <div className='text-center m-4' ><a className='px-4' href="https://github.com/Iqbalhossainshuvo/RESELLER-CAR-Client">Client site code</a> <a href="https://github.com/Iqbalhossainshuvo/RESELLER-CAR-SERVER">Server site code</a> </div>
        </div>
